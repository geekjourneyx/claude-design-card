...
description: 将任意文本、网页或 URL 转化为精致的可发布卡片。支持 14 种格式（公众号/视频号/B站/抖音封面 + 小红书图文/步骤/对比卡 + 金句/数据/方形分享卡 + The Broadsheet/Feature/Reader/Digest 长文编辑排版）。严格遵循 Claude/Anthropic 设计系统：Parchment 暖色基调、Georgia 衬线字体、Terracotta 强调色。当用户提到"信息卡、卡片摘要、文章配图、内容提炼、社交分享图、把链接做成卡片、生成海报式摘要、公众号封面、视频号封面、小红书笔记、抖音封面、金句卡、报纸排版、杂志排版"时使用本技能。
---
